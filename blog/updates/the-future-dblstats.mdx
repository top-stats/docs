...
Influx will be carrying hour timebased data, whilst postgres will be housing the generalistic data (names, descriptions, etc)

Why now? Well when we first started the initial **DBL Statistics v2** rewrite, we went with what we knew.
Which was a combination of EJS, MongoDB and Express.
