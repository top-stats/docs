...
import { BracesIcon, CodeIcon, CogIcon } from 'lucide-react'
...
<h4 className="text-fd-muted-foreground scroll-m-20">
  ...
  <Card icon={<CogIcon className="text-orange-400" />} href="./libraries/rust" title="Rust Library">
    A type-safe Rust client with async and blocking support!
  </Card>
</Cards>
