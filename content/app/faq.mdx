...
<Accordions type='single'>
  <Accordion id='disable-command' title='How can I disable a command?'>
    <Steps>
      <Step>
        ...
        ![server-settings-image](/content/faq/app/server-settings.png)
      </Step>
      <Step>
      ...
      <Step>
        ...
        ![get-bot-image](/content/faq/app/get-bot.png)
      </Step>
      <Step>
        Click the command you want to disable, select the **@everyone** role,
        set it to **❌**, then click **Save**.
        ![edit-permissions-image](/content/faq/app/edit-permissions.png)
      </Step>
    </Steps>
    <Callout type={'info'}>
  ...
  >
    ...
    ![permission-image](/content/faq/app/permission-external-emojis.png)
  </Accordion>
  <Accordion
  ...
  <Accordion id='deauthorize-app' title='TopStats slash commands are still showing after I removed the bot from my server.'>
    ...
    ![deauthorize-app-image](/content/faq/app/deauthorize-app.png)
  </Accordion>
</Accordions>
