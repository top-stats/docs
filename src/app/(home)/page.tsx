  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="container px-4 pt-[50px] md:pt-[100px] pb-12 md:pb-24 lg:pb-32">
        ...
        >
          <h1
            className="mb-6 flex items-center justify-center gap-2 md:gap-4 text-4xl md:text-[80px] font-semibold tracking-[-1px] md:tracking-[-2.4px] leading-[110%] font-['Inter']">
            <Image
              src={LogoSvg}
              alt="TopStats Logo"
