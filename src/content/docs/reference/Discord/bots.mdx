    ...
    <Tabs>
        ...
        <TabItem label="Body">
            <Card>
              ...
              | `percentageChanges.daily`                                    | Percentage change of the last day        | <Badge text="number" variant="note" />                                         |
              | `percentageChanges.monthly`                                  | Percentage change of the last monthly    | <Badge text="number" variant="note" />                                         |
            </Card>
        </TabItem>
    </Tabs>
