    ...
    <Tabs>
        ...
        <TabItem label="Body">
            <Card>
                ...
                | ---------------------------------------------------------- | ---------------------------------------- | ------------------------------------------------------------------------------ |
                | `certified`                                                | Is the Bot Certified On Top.gg?          | <Badge text="boolean" variant="note" />                                        |
                | `owners`  <Badge text={'Deprecated'} variant={'danger'} /> | Array of Discord ID's                    | <Badge text="array" variant="note" />  <Badge text="null" variant="caution" /> |
